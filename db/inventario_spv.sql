...
*/
-- PERSONA -> USUARIO
ALTER TABLE USUARIO ADD PERSONA INT;
ALTER TABLE USUARIO 
...
-- PERSONA -> CLIENTE
ALTER TABLE CLIENTE ADD PERSONA INT;
ALTER TABLE CLIENTE 
...
ALTER TABLE PRODUCTO ADD DEPARTAMENTO INT;
...
-- PRODUCTO -> INVENTARIO
ALTER TABLE INVENTARIO ADD PRODUCTO INT;
...
-- PROVEDOR -> INVENTARIO
ALTER TABLE INVENTARIO ADD PROVEEDOR INT;
ALTER TABLE INVENTARIO 
...
-- CLIENTE -> INVENTARIO
ALTER TABLE INVENTARIO ADD CLIENTE INT;
ALTER TABLE INVENTARIO 
  ADD CONSTRAINT FK_INVENTARIO_CLIENTE 
  FOREIGN KEY (CLIENTE) 
  REFERENCES CLIENTE(ID_CLIENTE);


-- PRODUCTO -> HISTORIAL_PRODUCTO
ALTER TABLE HISTORIAL_PRODUCTO ADD PRODUCTO INT;
ALTER TABLE HISTORIAL_PRODUCTO 
  ADD CONSTRAINT FK_HISTORIAL_PRODUCTO_PRODUCTO 
  FOREIGN KEY (PRODUCTO) 
  REFERENCES PRODUCTO(ID_PRODUCTO);


-- PRODUCTO -> VENTA
ALTER TABLE VENTA ADD PRODUCTO INT;
ALTER TABLE VENTA 
...
-- MEDIO_PAGO -> VENTA
ALTER TABLE VENTA ADD MEDIO_PAGO INT;
ALTER TABLE VENTA 
  ADD CONSTRAINT FK_VENTA_MEDIO_PAGO 
  FOREIGN KEY (MEDIO_PAGO) 
  REFERENCES MEDIO_PAGO(ID_MEDIO_PAGO);


-- VENTA -> DETALLE_VENTA
ALTER TABLE DETALLE_VENTA ADD VENTA INT;
...
ALTER TABLE DETALLE_VENTA ADD USUARIO INT;
ALTER TABLE DETALLE_VENTA 
  ADD CONSTRAINT FK_DETALLE_VENTA_USUARIO 
  FOREIGN KEY (USUARIO) 
  REFERENCES USUARIO(ID_USUARIO);

-- CLIENTE -> DETALLE_VENTA
ALTER TABLE DETALLE_VENTA ADD CLIENTE INT;
ALTER TABLE DETALLE_VENTA 
...
-- PRODUCTO -> COMPRA
ALTER TABLE COMPRA ADD PRODUCTO INT;
ALTER TABLE COMPRA 
...
-- MEDIO_PAGO -> COMPRA
ALTER TABLE COMPRA ADD MEDIO_PAGO INT;
ALTER TABLE COMPRA 
...
ALTER TABLE DETALLE_COMPRA ADD COMPRA INT;
...
ALTER TABLE DETALLE_COMPRA ADD USUARIO INT;
ALTER TABLE DETALLE_COMPRA 
  ADD CONSTRAINT FK_DETALLE_COMPRA_USUARIO 
  FOREIGN KEY (USUARIO) 
  REFERENCES USUARIO(ID_USUARIO);

-- PROVEEDOR -> DETALLE_COMPRA
ALTER TABLE DETALLE_COMPRA ADD PROVEEDOR INT;
ALTER TABLE DETALLE_COMPRA 
...
-- DETALLE_COMPRA -> CAJA
ALTER TABLE CAJA ADD DETALLE_COMPRA INT;
ALTER TABLE CAJA 
  ADD CONSTRAINT FK_CAJA_DETALLE_COMPRA 
  FOREIGN KEY (DETALLE_COMPRA) 
  REFERENCES DETALLE_COMPRA(ID_DETALLE_COMPRA);

-- DETALLE_VENTA -> CAJA
ALTER TABLE CAJA ADD DETALLE_VENTA INT;
ALTER TABLE CAJA 
  ADD CONSTRAINT FK_CAJA_DETALLE_VENTA 
  FOREIGN KEY (DETALLE_VENTA) 
  REFERENCES DETALLE_VENTA(ID_DETALLE_VENTA);


--      MOVIMIENTO -> VENTA
ALTER TABLE VENTA ADD INFORMACION_MOVIMIENTO INT;
ALTER TABLE VENTA 
  ADD CONSTRAINT FK_VENTA_MOVIMIENTO
  FOREIGN KEY (INFORMACION_MOVIMIENTO)
  REFERENCES MOVIMIENTO(ID_MOVIMIENTO);
--      MOVIMIENTO -> COMPRA
ALTER TABLE COMPRA ADD INFORMACION_MOVIMIENTO INT;
ALTER TABLE COMPRA
  ADD CONSTRAINT FK_COMPRA_MOVIMIENTO
  FOREIGN KEY (INFORMACION_MOVIMIENTO)
  REFERENCES MOVIMIENTO(ID_MOVIMIENTO);
...
DESCRIBE PRODUCTO;
INSERT INTO PRODUCTO (CODE_BAR, NOMBRE_PRODUCTO, MARCA, DETALLE_PRODUCTO,CANTIDAD )
	VALUES (985430, "Leche chavo", "Negas","WENA", 180);
...
SELECT CMP.ID_COMPRA,
	...
	INNER JOIN PRODUCTO AS PROD
		ON CMP.ID_COMPRA = PROD.ID_PRODUCTO
    INNER JOIN MEDIO_PAGO AS MDPG
		ON CMP.ID_COMPRA = MDPG.ID_MEDIO_PAGO
	INNER JOIN MOVIMIENTO AS MOV
		ON CMP.ID_COMPRA = MOV.ID_MOVIMIENTO;
...
INSERT INTO PROVEEDOR(RUT_EMPRESA, NOMBRE_EMPRESA, FONO, DIRECCION)
	VALUES ("70788799-2", "PROVEEDOR", "+95962345", "EL REPARTIDOR 1");
    
DESCRIBE DETALLE_COMPRA;
INSERT INTO DETALLE_COMPRA(COMPRA, USUARIO, PROVEEDOR)
	VALUE (1, 1, 1);
...
SELECT  DC.ID_DETALLE_COMPRA,
 ...
 INNER JOIN USUARIO AS U
  ON U.ID_USUARIO = DC.ID_DETALLE_COMPRA
   INNER JOIN PERSONA AS PER
	ON PER.ID_PERSONA = U.ID_USUARIO
INNER JOIN COMPRA AS C
	ON C.ID_COMPRA = DC.ID_DETALLE_COMPRA
INNER JOIN PROVEEDOR AS P
	ON P.ID_PROVEEDOR = DC.ID_DETALLE_COMPRA;
